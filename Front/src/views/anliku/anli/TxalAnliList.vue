        ...
        <a-row :gutter="24">
          <a-col :lg="8">
            <a-form-item label="案例名称" name="name">
              <j-input placeholder="请输入案例名称" v-model:value="queryParam.name"></j-input>
            </a-form-item>
          </a-col>
          <a-col :lg="8">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :lg="8">
              <a-form-item label="案例编号" name="code">
                <j-input placeholder="请输入案例编号" v-model:value="queryParam.code"></j-input>
              </a-form-item>
            </a-col>
          </template>
...
import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './TxalAnli.api';
